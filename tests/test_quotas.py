...
class TestQuotas(BaseTest):
    def test_service_quota_request_history_filter(self):
        session_factory = self.replay_flight_data('test_service_quota_history_filter')
        policy = yaml_load("""
    ...
    #     session_factory = self.replay_flight_data('test_service_quota_request_increase')
    #     policy = yaml_load("""
    ...
    #     session_factory = self.replay_flight_data('test_service_quota_metric_filter')
    #     policy = yaml_load("""
    ...
    #     session_factory = self.replay_flight_data('test_service_quota_put_request_in_template')
    #     policy = yaml_load("""
